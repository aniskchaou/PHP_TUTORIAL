...
One of the environment variables set by PHP is HTTP_USER_AGENT which identifies 
...
PHP provides a function getenv() to access the value of all the environment variables.
 The information contained in the HTTP_USER_AGENT environment variable can be used 
 to create dynamic content appropriate to the browser.
-->
<html>
   <body>
